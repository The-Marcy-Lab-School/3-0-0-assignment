...
describe(testSuiteName, () => {
  ...
  it('should return an array of 4 colors as a promise', () => {
    expect(return4RandomColors()).toBeInstanceOf(Promise);
    expect(return4RandomColors()).resolves.toBeInstanceOf(Array);
    scoreCounter.correct(expect); // DO NOT TOUCH
  });

  it('should return 4 different colors each time', () => {
    let firstColor1;
    let firstColor2;
    let firstColor3;
    let firstColor4;
